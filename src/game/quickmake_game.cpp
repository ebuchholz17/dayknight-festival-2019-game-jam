...
extern "C" void getGameAssetList (asset_list *assetList) {
    ...
    pushAsset(assetList, "assets/textures/player_bullet.bmp", ASSET_TYPE_BMP, TEXTURE_KEY_PLAYER_BULLET);
    pushAsset(assetList, "assets/textures/player_hurt.bmp", ASSET_TYPE_BMP, TEXTURE_KEY_PLAYER_HURT);
    pushAsset(assetList, "assets/textures/white_box.bmp", ASSET_TYPE_BMP, TEXTURE_KEY_WHITE_BOX);
    pushAsset(assetList, "assets/textures/yellow_box.bmp", ASSET_TYPE_BMP, TEXTURE_KEY_YELLOW_BOX);
    pushAsset(assetList, "assets/textures/green_box.bmp", ASSET_TYPE_BMP, TEXTURE_KEY_GREEN_BOX);
    pushAsset(assetList, "assets/textures/bg.bmp", ASSET_TYPE_BMP, TEXTURE_KEY_BG);
    pushAsset(assetList, "assets/textures/bass.bmp", ASSET_TYPE_BMP, TEXTURE_KEY_BASS);
    pushAsset(assetList, "assets/textures/boss_hurt.bmp", ASSET_TYPE_BMP, TEXTURE_KEY_BOSS_HURT);
    pushAsset(assetList, "assets/textures/fish_meter.bmp", ASSET_TYPE_BMP, TEXTURE_KEY_FISH_METER);
    pushAsset(assetList, "assets/textures/meter_fish.bmp", ASSET_TYPE_BMP, TEXTURE_KEY_METER_FISH);
    pushAsset(assetList, "assets/textures/line.bmp", ASSET_TYPE_BMP, TEXTURE_KEY_LINE);
}
